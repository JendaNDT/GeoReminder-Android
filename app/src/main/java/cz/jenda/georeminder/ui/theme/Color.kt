...
val LightGeoColors = GeoColors(
    ...
    tertiaryLabel = Color(0x803C3C43),    // 50 % (WCAG AA > 4.5:1)
...
val DarkGeoColors = GeoColors(
    ...
    tertiaryLabel = Color(0x80EBEBF5),    // 50 %
...
val NeutralGeoColors = GeoColors(
    ...
    secondaryLabel = Color(0x9E3A342B),
    tertiaryLabel = Color(0x803A342B),    // 50 %
...
val GlassGeoColors = GeoColors(
    ...
    label = Color(0xFF1E2140),
    secondaryLabel = Color(0x9E1E2140),
    tertiaryLabel = Color(0x8C1E2140),    // 55 %
    separator = Color(0x1F1E2140),
    green = Color(0xFF2FA36B),
    red = Color(0xFFFF3B30),
    orange = Color(0xFFFF8C00),
    yellow = Color(0xFFFFCC00),
    teal = Color(0xFF17B8C7),
