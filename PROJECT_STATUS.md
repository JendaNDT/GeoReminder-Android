...
- **UI & WCAG AA/AAA kontrast:** Vlastní iOS-look komponenty a 3 čitelná témata (Světlé, Tmavé, Neutrální). Glass režim byl po smoke testu odstraněn kvůli slabému kontrastu a rušivému vrstvení. Oranžový Permission banner s tmavým textem `#1C1C1E` splňuje kontrast **> 7:1** (WCAG AAA).
